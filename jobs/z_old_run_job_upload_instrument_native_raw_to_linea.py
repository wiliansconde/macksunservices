...
Job: z_old_run_job_upload_instrument_native_raw_to_linea.py
...
Uso Manual:
    ...
    SST (Raiz completa)
       python -m jobs.run_job_upload_instrument_native_raw_to_linea --path "C:\Y\WConde\Estudo\DoutoradoMack\Disciplinas\_PesquisaFinal\DadosSST" --instrument "sst"
